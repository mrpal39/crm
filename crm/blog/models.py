...
from crm.dashboard.models import Author
...
class Blog(models.Model):
    ...
    # sub_catagories = models.ManyToManyField(Subcategory)
    catagories = models.ForeignKey(Catagory,on_delete=models.DO_NOTHING, null=True, blank=True)
